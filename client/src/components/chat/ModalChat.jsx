...
function ModalChat({ isOpen: isOpenProp, onOpen, onClose }) {
    ...
    // Sync internal state với prop từ parent
    useEffect(() => {
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="fixed bottom-28 right-6 z-50 w-[380px] md:w-[420px] shadow-2xl rounded-2xl overflow-hidden"
                    >
