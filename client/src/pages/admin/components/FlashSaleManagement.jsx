    ...
    const handleSubmit = async (values) => {
        ...
        try {
            if (editingFlashSale) {
                ...
                await requestEditFlashSale(editingFlashSale._id, updatedFlashSale);
    ...
    const columns = [
        {
            ...
            render: (productId) => {
                return (
                    <img
                        src={`${import.meta.env.VITE_URL_IMAGE}/uploads/products/${productId.images?.[0]}`}
                        alt={productId.title}
        ...
        },
        {
            ...
            render: (productId) => {
                return (
                    <div>
                        <div className="font-medium text-sm">{productId.title}</div>
                    </div>
                );
            },
        },
